...
def inicializar_vista():
    ...
    global boton_alta, boton_consulta, boton_borrar, boton_cambiar_color
    global tree, scrollbar, agregar_producto, eliminar_producto
    ...
    boton_consulta = tk.Button(
        root, text="Sumar Total", command=dar_resultado.consultar
    )
